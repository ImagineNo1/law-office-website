...
export const recoveryServices = [
  [
    "تنظیم قرارداد",
    "contract-drafting",
    "تنظیم قراردادهای ملکی، استخدامی، مشارکت و کسب‌وکار با کنترل ریسک و بندهای قابل امضا.",
    "قرارداد",
    "۲۴ تا ۴۸ ساعت",
  ],
  [
    "مشاوره حقوقی",
    "legal-consultation",
    "جلسه مشاوره با وکیل متخصص، خلاصه ریسک، مسیر اقدام و مدارک موردنیاز.",
    "مشاوره",
    "همان روز",
  ],
  [
    "تنظیم دادخواست",
    "petition-drafting",
    "تهیه دادخواست حقوقی با خواسته دقیق، مستندات، خوانده و مرجع صالح.",
    "دعاوی",
    "۴۸ ساعت",
  ],
  [
    "تنظیم شکواییه",
    "criminal-complaint",
    "شکواییه کیفری با تشخیص عنوان اتهامی، ادله و شرح منظم واقعه.",
    "کیفری",
    "۴۸ ساعت",
  ],
  [
    "تنظیم اظهارنامه",
    "legal-notice",
    "اظهارنامه رسمی برای مطالبه، اخطار، اعلام موضع یا شروع مسیر قانونی.",
    "ابلاغ",
    "۲۴ ساعت",
  ],
  [
    "تنظیم لایحه",
    "defense-brief",
    "لایحه دفاعیه یا توضیحی با تحلیل پرونده، استناد به مدارک و دفاع منظم.",
    "دفاع",
    "۷۲ ساعت",
  ],
  [
    "پیگیری پرونده",
    "case-follow-up",
    "رصد وضعیت پرونده، ابلاغیه‌ها، مهلت‌ها و گزارش اقدام بعدی.",
    "پرونده",
    "هفتگی",
  ],
  [
    "امضای دیجیتال اسناد",
    "digital-signature",
    "ارسال قرارداد برای امضا، پیگیری وضعیت و بایگانی گواهی امضا.",
    "امضا",
    "فوری",
  ],
] as const;
...
export const recoveryContracts = Array.from({ length: 24 }, (_, index) => ({
  ...
  rating: "۴.۸",
  description:
    "قالب حقوقی آماده با بندهای ضروری، چک‌لیست مدارک، امکان سفارشی‌سازی و مسیر امضای دیجیتال.",
}));
...
export const crmRequests = Array.from({ length: 50 }, (_, index) => ({
  ...
  client: ["علی محمدی", "سارا رضایی", "شرکت توسعه پارس", "موسسه حقوقی داوران"][
    index % 4
  ],
  service: recoveryServices[index % recoveryServices.length][0],
  status: ["جدید", "در بررسی", "در حال انجام", "در انتظار موکل", "تکمیل شده"][
    index % 5
  ],
...
export const dashboardEvents = Array.from({ length: 30 }, (_, index) => ({
  ...
  title: [
    "درخواست جدید ثبت شد",
    "سند برای امضا ارسال شد",
    "پیام موکل پاسخ داده شد",
    "پرداخت تایید شد",
    "قرارداد بایگانی شد",
  ][index % 5],
...
export const recoveryFaqs = [
  [
    "مدت زمان تنظیم قرارداد چقدر است؟",
    "برای قراردادهای متعارف ۲۴ تا ۴۸ ساعت کاری و برای موارد تخصصی پس از بررسی مدارک زمان‌بندی دقیق اعلام می‌شود.",
  ],
  [
    "آیا امکان امضای دیجیتال وجود دارد؟",
    "بله، سند از مرکز امضای دیجیتال برای امضاکنندگان ارسال و وضعیت مشاهده، امضا یا رد شدن پیگیری می‌شود.",
  ],
  [
    "آیا اطلاعات محرمانه می‌ماند؟",
    "دسترسی اسناد با نقش‌ها، سطح دسترسی و ثبت رویدادهای امنیتی کنترل می‌شود.",
  ],
  [
    "آیا قالب‌ها قابل ویرایش هستند؟",
    "قالب‌ها ساختاریافته هستند و قبل از ارسال برای امضا قابل شخصی‌سازی و بازبینی حقوقی‌اند.",
  ],
];
