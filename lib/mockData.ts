import type { AdminContentRow, Article, DashboardMetric, MessagePreview, NewsItem, Service, SiteStat, TrustFeature } from "@/types";
...
export const services: Service[] = [
  {
    title: "دعاوی خانواده",
    excerpt: "طلاق، حضانت، مهریه، نفقه، توافق های خانوادگی و امور مربوط به خانواده.",
  },
  {
    title: "دعاوی ملکی",
  ...
  {
    title: "قراردادها",
    excerpt: "تنظیم و بررسی انواع قراردادهای داخلی و بین المللی با رویکرد کاهش ریسک.",
  },
  {
    title: "امور شرکت ها",
    excerpt: "ثبت شرکت، تغییرات، دعاوی سهامداران، قراردادهای تجاری و مشاوره مدیران.",
  },
  {
    title: "داوری و حل اختلاف",
    excerpt: "میانجی گری، داوری، مذاکره و طراحی مسیر حل اختلاف بدون فرسایش طولانی.",
  },
  {
    title: "دفاع کیفری",
    excerpt: "دفاع در جرایم اقتصادی، مالی، چک، کلاهبرداری و پرونده های کیفری تخصصی.",
  },
];
...
export const blogPosts: Article[] = [
  {
    ...
    excerpt: "چک لیستی برای تعیین سهم، تعهدات، ضمانت اجرا و روش خروج از قرارداد مشارکت.",
    category: "قراردادها",
  ...
  },
  {
    ...
    excerpt: "مروری بر اجاره نامه، ودیعه، تمدید، تخلیه و اختلافات رایج میان موجر و مستاجر.",
    category: "دعاوی ملکی",
...
export const newsItems: NewsItem[] = [
  {
    ...
    excerpt: "واحد تخصصی دعاوی خانوادگی با تمرکز بر مشاوره محرمانه و پیگیری سریع آغاز به کار کرد.",
  ...
  },
  {
    ...
    excerpt: "کارگاه تخصصی تحلیل قراردادهای مشارکت و بندهای پرریسک آن برگزار می شود.",
...
export const adminRows: AdminContentRow[] = [
  { title: "نکات مهم در تنظیم قرارداد مشارکت", category: "قراردادها", date: "۱۴۰۳/۰۳/۲۰", status: "منتشر شده" },
  { title: "افتتاحیه جدید بخش دعاوی خانوادگی", category: "خبر", date: "۱۴۰۳/۰۳/۲۱", status: "منتشر شده" },
  { title: "بررسی حقوق و تکالیف موجر و مستاجر", category: "ملکی", date: "۱۴۰۳/۰۳/۱۵", status: "منتشر شده" },
  { title: "بررسی دعاوی خانواده در سال ۱۴۰۳", category: "خانواده", date: "۱۴۰۳/۰۲/۲۴", status: "پیش نویس" },
];
...
export const messagePreviews: MessagePreview[] = [
  { name: "علی محمدی", email: "ali@example.com", subject: "مشاوره در زمینه دعاوی ملکی", status: "جدید", date: "۱۴۰۳/۰۳/۲۲" },
  { name: "سارا رضایی", email: "sara@example.com", subject: "سوال درباره قراردادها", status: "خوانده شده", date: "۱۴۰۳/۰۳/۲۱" },
  { name: "محمد کریمی", email: "karimi@example.com", subject: "پیگیری پرونده حقوقی", status: "جدید", date: "۱۴۰۳/۰۳/۱۸" },
  { name: "فاطمه احمدی", email: "ahmadi@example.com", subject: "مشاوره خانوادگی", status: "خوانده شده", date: "۱۴۰۳/۰۳/۱۵" },
];
