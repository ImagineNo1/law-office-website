  ...
  return (
    <div className="grid gap-5 lg:grid-cols-[320px_1fr]">
      <PortalCard className="p-5">
        ...
        <form action={sendClientMessageAction} className="mb-4 grid gap-3 rounded-lg border border-border bg-white p-3">
