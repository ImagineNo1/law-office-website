...
const links = [
  ...
  { label: "پرونده‌ها", href: "/dashboard/cases", icon: "M4 7h7l2 2h7v10H4V7Z" },
  ...
  { label: "تنظیمات", href: "/dashboard/settings", icon: "M12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8Zm0-5v2M12 19v2M3 12h2M19 12h2" },
];
    ...
    <aside className="bg-admin-nav px-4 py-6 text-white shadow-[24px_0_70px_rgba(0,0,0,0.18)] lg:sticky lg:top-0 lg:min-h-screen lg:w-[306px]">
      <Link className="mb-10 flex items-center gap-3 [&_*]:text-white" href="/dashboard">
        ...
        <span>
          ...
          <span className="text-sm text-slate-300">سامانه خدمات حقوقی</span>
        </span>
      </Link>
      ...
      <div className="mt-16 rounded-2xl bg-white/8 p-5">
        <p className="text-sm font-black text-white">مشاوره تلفنی رایگان</p>
        <p className="mt-2 text-xs leading-6 text-slate-300">برای سوالات حقوقی</p>
        <Link className="mt-4 flex items-center justify-center gap-2 rounded-xl border border-gold px-4 py-3 text-sm font-black text-gold" href="/requests/new">درخواست مشاوره ☎</Link>
      </div>
    </aside>
  );
}
