      ...
      <div className="mx-auto w-[min(1440px,calc(100%-32px))]">
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          {contracts.slice(0, 8).map((contract) => (
            <Link className="rounded-2xl border border-slate-200 bg-slate-50 p-5 transition hover:-translate-y-1 hover:border-[#C9973F]" href={`/contracts/${contract.category}/${contract.slug}`} key={contract.id}>
              ...
              <div className="mt-4 flex items-center justify-between border-t border-slate-200 pt-4 text-xs font-black">
