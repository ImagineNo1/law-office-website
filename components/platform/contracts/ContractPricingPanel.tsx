...
export function ContractPricingPanel({
  ...
  return (
    <aside className="rounded-2xl bg-white p-6 shadow-[0_18px_45px_rgba(11,23,42,.06)] lg:sticky lg:top-28 lg:self-start">
      ...
      <strong className="mt-2 block text-3xl font-black text-[#C9973F]">
        {contract.price}
      </strong>
      ...
      <Link
        className="mt-5 flex h-12 items-center justify-center rounded-xl bg-[#C9973F] text-sm font-black text-white"
