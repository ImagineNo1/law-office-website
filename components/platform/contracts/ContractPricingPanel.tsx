  ...
  return (
    <aside className="rounded-2xl bg-white p-6 shadow-[0_18px_45px_rgba(11,23,42,.06)] lg:sticky lg:top-28 lg:self-start">
      ...
      <div className="mt-5 grid gap-3 text-sm font-black">
        <span className="rounded-xl bg-slate-50 p-3">دانلود: {contract.downloads}</span>
        <span className="rounded-xl bg-slate-50 p-3">امتیاز کاربران: {contract.rating}</span>
        <span className="rounded-xl bg-slate-50 p-3">آماده ارسال برای امضا</span>
      </div>
