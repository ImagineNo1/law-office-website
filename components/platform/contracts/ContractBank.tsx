...
export function ContractBank() {
  return (
    <div>
      <div className="mb-5 flex flex-col gap-3 rounded-2xl border border-[#eadfce] bg-white p-4 shadow-[0_18px_45px_rgba(11,23,42,.05)] md:flex-row md:items-center md:justify-between">
