  ...
  return (
    <section className="bg-[#0B172A] py-10 text-white">
      <Container className="grid gap-6 lg:grid-cols-[1fr_370px]">
        <div>
          <span className="text-sm font-black text-[#D4A64A]">
            مرکز خدمات حقوقی
          </span>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/8 p-5">
          <h2 className="font-black">
            {detail ? "خلاصه اجرای خدمت" : "وضعیت ظرفیت امروز"}
          </h2>
          <div className="mt-4 grid gap-3">
            {["وکلای آماده پاسخ", "پرونده‌های در صف", "میانگین پاسخ"].map(
              (x, i) => (
                <div
                  className="flex justify-between rounded-xl bg-white/10 p-3 text-sm font-black"
                  key={x}
                >
                  <span>{x}</span>
