  ...
  return (
    <section className="container-shell py-20">
      <div className="relative overflow-hidden rounded-[28px] border border-white/10 bg-[#071225] p-8 text-white shadow-soft sm:p-10 lg:p-14">
        <div className="absolute -left-16 -top-16 size-56 rounded-full bg-emerald-700/24 blur-3xl" />
        <div className="absolute -right-20 bottom-0 size-60 rounded-full bg-white/8 blur-3xl" />
        <div className="absolute inset-x-8 top-0 h-px bg-gradient-to-l from-transparent via-emerald-500/45 to-transparent" />

        <div className="relative grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
          <div>
            <p className="text-sm font-black text-emerald-700">{cta.eyebrow}</p>
