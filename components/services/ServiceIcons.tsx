...
export function ServiceIcon({
  ...
  if (name === "gavel") {
    return (
      <svg {...common}>
        <path
          d="m13 5 6 6M5 13l6 6M11 7l6 6-4 4-6-6 4-4Zm-2 8-5 5"
          stroke="currentColor"
          strokeLinecap="round"
  ...
  if (name === "case") {
    return (
      <svg {...common}>
        <path
          d="M9 6V5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v1m5 4v9H4v-9m16 0H4m16 0V7H4v3m6 3h4"
          stroke="currentColor"
          strokeLinecap="round"
          strokeLinejoin="round"
          strokeWidth="1.7"
  ...
  if (name === "folder") {
    return (
      <svg {...common}>
        <path
          d="M4 6h6l2 2h8v10.5A1.5 1.5 0 0 1 18.5 20h-13A1.5 1.5 0 0 1 4 18.5V6Z"
          stroke="currentColor"
          strokeLinejoin="round"
          strokeWidth="1.7"
        />
  ...
  if (name === "calendar") {
    return (
      <svg {...common}>
        <path
          d="M7 4v3m10-3v3M4.5 9h15M6 6h12a1.5 1.5 0 0 1 1.5 1.5V19A1.5 1.5 0 0 1 18 20.5H6A1.5 1.5 0 0 1 4.5 19V7.5A1.5 1.5 0 0 1 6 6Z"
          stroke="currentColor"
          strokeLinecap="round"
          strokeLinejoin="round"
          strokeWidth="1.7"
