        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_0.8fr] lg:items-center">
          <div>
            ...
            <h1 className="mt-3 text-4xl font-black leading-[1.35] text-foreground">
              {page?.title ?? "موسسه ای برای راهبری حقوقی دقیق و قابل اعتماد"}
            </h1>
            <p className="mt-6 whitespace-pre-line leading-9 text-muted">
              {page?.content ??
                "هدف موسسه، تبدیل مسائل پیچیده حقوقی به مسیرهای روشن اجرایی است."}
            </p>
          </div>
          <Card className="p-6">
            <h2 className="text-2xl font-black text-gold">
              {page?.subtitle ?? "ماموریت ما"}
            </h2>
            <p className="mt-4 leading-8 text-muted">
              حمایت حقوقی تخصصی از موکلین با حفظ کرامت، شفافیت و انضباط حرفه
              ای.
            </p>
          </Card>
        </div>
