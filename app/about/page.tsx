...
export default async function AboutPage() {
  ...
  const values = [
    [
      ...
      "هر درخواست مسیر، وضعیت و پیام‌های قابل پیگیری دارد.",
    ],
    [
      "محرمانگی اطلاعات",
      "اطلاعات هویتی، اسناد و مکاتبات با نگاه حقوقی و محرمانه مدیریت می‌شود.",
    ],
    [
      "دسترسی ساده به خدمات حقوقی",
      "کاربر بدون درگیری با اصطلاحات پیچیده، خدمت مناسب را انتخاب و ثبت می‌کند.",
    ],
    [
      "تجربه دیجیتال قراردادها",
      "بانک قرارداد، فرم‌ها و درخواست‌ها در یک جریان منظم کنار هم قرار گرفته‌اند.",
    ],
  ];
        ...
        <Container>
          <div className="grid gap-6 lg:grid-cols-[1fr_380px]">
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-[0_18px_45px_rgba(11,23,42,.05)]">
              <h2 className="text-2xl font-black text-[#0B172A]">
                پلتفرم حقوقی برای کار روزمره موکل و تیم حقوقی
              </h2>
            ...
            <div className="rounded-2xl bg-[#0B172A] p-6 text-white shadow-[0_18px_45px_rgba(11,23,42,.12)]">
              ...
              <p className="mt-4 text-sm font-bold leading-8 text-slate-200">
                تبدیل موضوعات حقوقی پیچیده به مسیرهای قابل فهم، قابل پیگیری و
                قابل اقدام.
              </p>
            </div>
          </div>
          ...
          <div className="mt-8 rounded-2xl border border-accent/20 bg-accent/10 p-6">
            ...
            <p className="mt-3 text-sm font-bold leading-8 text-slate-600">
              برای انتخاب خدمت مناسب، از صفحه خدمات شروع کنید یا درخواست حقوقی
              خود را ثبت کنید.
            </p>
            <div className="mt-5 flex flex-wrap gap-3">
              ...
              <Link
                className="inline-flex h-12 items-center rounded-xl bg-white px-6 text-sm font-black text-[#0B172A]"
                href="/services"
              >
                مشاهده خدمات
              </Link>
