        ...
        <div className="container-shell grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          ...
          <div>
            ...
            <p className="mt-5 leading-9 text-muted">
              عدالت گستر برای پرونده‌هایی طراحی شده که به تحلیل دقیق، محرمانگی،
              پیگیری منظم و ارتباط شفاف نیاز دارند. تیم موسسه مسیر حقوقی را به
              زبان قابل فهم و با برنامه اجرایی روشن ارائه می‌کند.
            </p>
