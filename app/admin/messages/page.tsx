...
import { sendAdminClientMessageAction } from "@/lib/admin-actions";
...
export default async function AdminMessagesPage() {
  const conversations = await getAdminClientConversations();
  const active = conversations[0];
  return (
    <AdminShell title="پیام‌ها" description="پاسخگویی به چت کاربران داشبورد">
      <div className="grid gap-6">
        <AdminPageHeader
          title="پیام‌ها"
          description="گفتگوهای ایجادشده توسط کاربران در پورتال مشتری اینجا نمایش داده می‌شود."
        />
